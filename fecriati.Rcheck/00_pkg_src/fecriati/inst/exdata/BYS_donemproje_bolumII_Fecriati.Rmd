...
products = fecriati::read_data(product_path)
product_yeni <- "product_yeni.csv"


# Process users data
cat("Users Data\n")
users <- fecriati::process_data(users, users_yeni, remove_cols = c("X","latitude","longitude"))
typeof(users)
users$id
user_temiz
# Process orders data
cat("Orders Data\n")
orders_temiz <- fecriati::process_data(orders, orders_yeni, remove_cols = c("returned_at", "shipped_at", "delivered_at"))
...
db = fecriati::connect_to_database(db_path = db_path)
