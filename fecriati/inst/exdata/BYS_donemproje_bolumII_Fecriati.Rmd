...
Bu bölümde belirlediğimiz analizleri yapacağız. Verilerimizi WooCommerce API ile çektik. Analiz yaparken knit dosyasının hata vermemesi için verilerimizi csv dosyalarından okuduk. API işlemleri R/ApiOperations dosyasında mevcuttur.
